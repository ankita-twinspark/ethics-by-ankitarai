...
'menu_name' => _x('cartoon', 'admin menu'),
'name_admin_bar' => _x('cartoon', 'admin bar'),
'add_new' => _x('Add cartoon', 'add cartoon'),
'add_new_item' => __('Add cartoon'),
'new_item' => __('New cartoon'),
'edit_item' => __('Edit cartoon'),
'view_item' => __('View cartoon'),
'all_items' => __('All cartoon'),
'search_items' => __('Search cartoon'),
'not_found' => __('No cartoon found.'),
);

$args = array(
'supports' => $supports,
'labels' => $labels,
'description' => 'Holds our cartoon and specific data',
'public' => true,
'taxonomies' => false,
'show_ui' => true,
'show_in_menu' => true,
...
register_post_type('cartoon', $args); // Register Post type
}
...
//custom field with in custom post type
function wporg_add_custom_box() {
    $screens = [ 'cartoon' ];
    foreach ( $screens as $screen ) {
        add_meta_box(
            'wporg_box_id',                 // Unique ID
            'Search for your fav.',      // Box title
...
function wporg_custom_box_html( $post ) {
    ...
    ?>
    <label for="wporg_field">Cartoon name please</label>
